    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="dashboard.php"> Buat Survei </a></li>
    ...
    <section id="values" class="values">
      <div class="container" data-aos="fade-up">
        <header class="section-header">
          <!-- <h2>Our Values</h2> -->
          <img src="assets/img/warn-red.svg" width=100 alt=""> <br><br>
          <p>Anda Belum Login</p> <br>
          Klik tombol di bawah untuk melanjutkan login <br> <br>
          <button type='button' class='btn btn-primary' style="background-color: #0474BA; color: white;"> <a href='login.php'> Login </a> </button> <br><br>
        </header>
        <center>
        </center>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-2 col-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bi bi-chevron-right"></i> <a href="index#main">Fitur Kami</a></li>
