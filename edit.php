...
if (isset($_SESSION['id_pengguna'])) {
    ...
    <bodyyy>
        <form action="proses_edit_profile.php" method="post" enctype="multipart/form-data">
            <?php if ($user) { ?>
                <div class="d-flex justify-content-center align-items-center vh-100 height: calc(100vh - 150px);"
                    id="page-content">
                    <div class="col-sm-4 bg-c-lite-green user-profile align-items-center">
                        <div class="card-block text-center text-white">
                            ...
                            <h6 class="f-w-600">
                                <input type="text" class="form-control text-center" name="nama"
                    ...
                    <div class="col-sm-8 align-items-center">
                        <div class="card-block">
                            <h6 class="m-b-20 p-b-5 b-b-default f-w-600">Informasi Pengguna</h6>
                            <div class="row">
                                <div class="col-lg-10">
                                    ...
                                    <h6 class="text-muted f-w-600">
                                        ...
                                        <input hidden type="text" class="form-control" name="email"
                                            value="<?php echo $user['email'] ?>" hidden>
                                    </h6>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-2 col-6 footer-links">
                        ...
                        <ul>
                            ...
                            <li><i class="bi bi-chevron-right"></i> <a href="#">Fitur Kami</a></li>
                            <li><i class="bi bi-chevron-right"></i> <a href="#">Buat Survei</a></li>
                            <li><i class="bi bi-chevron-right"></i> <a href="#">Isi Survei</a></li>
                            <li><i class="bi bi-chevron-right"></i> <a href="#">Peringkat</a></li>
                        </ul>
                    </div>
...
<body>
    <?php if ($user) { ?>
        ...
        <div class="d-flex justify-content-center align-items-center vh-100">
            ...
            <form class="shadow w-450 p-3" action="proses_edit_profile.php" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="email" value="<?php echo $user['email'] ?>" hidden>
                </div>


                <div class="mb-3">
                    <label class="form-label">Profile Picture</label>
                    <input type="file" class="form-control" name="pp" hidden>
                    <img src="upload/<?= $user['pp'] ?>" hidden class="rounded-circle" style="width: 70px">
                    <input type="text" hidden="hidden" name="old_pp" value="<?= $user['pp'] ?>" hidden>
                </div>
