    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="isisurvei.php">Isi Survei</a></li>
...
$sql = "SELECT survei.id_survei, survei.judul_survei, survei.deskripsi_survei, survei.header_survei, 
        ...
        pengguna.nama, survei.kategori_survei
         ...
         WHERE NOT survei.id_pengguna = '$id_pengguna'
    ...
    while($i = mysqli_fetch_array($result)){
        ...
        echo '
            ...
            <div class="styles_tag_container">
                ...
                <div class="text-end">';
                    echo "<button type='button' class='btn btn-primary'> <a href='isisurvei_mulai.php?id=$id_survei'> Isi Survei </a></button>
                </div>
        </div>
      </div>";
    }
